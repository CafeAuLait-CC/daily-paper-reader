...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-05 22:06:41 UTC<br>状态：成功</p>
</section>
...
<p>今日速读2篇，聚焦3D场景生成与重建，暂无精读深度分析。</p>
<p>最值得关注的是《DReSG》（7.0分），用扩散残差实现风格化高斯泼溅，视觉风格迁移有新突破；《ReconSplat》则探索超出观测视角的通用重建。</p>
<p>建议优先精读DReSG，若对泛化重建感兴趣，可结合两篇对比学习。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="DReSG: Diffusion Residuals for Stylized Gaussian Splatting">DReSG: Diffusion Residuals for Stylized Gaussian Splatting</span></li><li><span class="dpr-home-dashboard-paper-title" title="ReconSplat: Generalizable 3D Scene Reconstruction Beyond Observed Views">ReconSplat: Generalizable 3D Scene Reconstruction Beyond Observed Views</span></li></ul>
  </div>
