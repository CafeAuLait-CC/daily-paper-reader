...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-04 22:47:41 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇、速读1篇，聚焦生成模型与3D视觉前沿。</p>
<p>最值得关注：精读论文《Beyond Straightness》提出“Quantile AlignTree Coupling”实现非交叉流匹配，评分高达9.0；速读论文探索3D基础场景表示的零样本新深度合成（6.0分），可作扩展了解。</p>
<p>建议优先精读高分的流匹配耦合方法，理解其树形分位对齐思路，再看速读论文如何利用3D先验生成新视角深度。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Beyond Straightness: Non-Crossing Flow Matching via Quantile AlignTree Coupling">Beyond Straightness: Non-Crossing Flow Matching via Quantile AlignTree Coupling</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Zero-Shot Novel Depth Synthesis Using 3D Foundation Models Scene Representations">Zero-Shot Novel Depth Synthesis Using 3D Foundation Models Scene Representations</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">dmg <strong>1</strong></span></div>
</section>
</div>
